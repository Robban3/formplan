...
export function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{
      ...
      {/* Main content — mobile: column/centered, desktop: exactly as before */}
      <div className="relative flex flex-1 z-10 items-center justify-center flex-col gap-8 px-4 py-8 lg:flex-row lg:gap-16 lg:px-12 lg:py-10">
