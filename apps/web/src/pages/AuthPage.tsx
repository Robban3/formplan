              ...
              {recovering ? (
                ...
                <>
                  ...
                  <button onClick={handleGoogle} disabled={busy}
                    className="w-full flex items-center justify-center gap-3 bg-white text-slate-900 font-semibold py-4 rounded-xl mb-5 hover:bg-slate-100 transition-colors text-sm disabled:opacity-60">
