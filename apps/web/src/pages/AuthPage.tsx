...
export function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{
      ...
      {/* Main content */}
      <div className="relative flex flex-1 z-10 items-center justify-center flex-col gap-8 px-4 py-10 lg:flex-row lg:gap-16 lg:px-12">
        ...
        {/* Right — login card */}
        <div className="w-full max-w-sm p-6 lg:w-[580px] lg:max-w-none lg:flex-shrink-0 lg:p-10" style={{
      ...
      {/* Bottom feature bar */}
      <div className="relative z-10 border-t px-6 py-5" style={{ borderColor: 'rgba(255,255,255,0.08)', background: 'rgba(0,0,0,0.5)' }}>
