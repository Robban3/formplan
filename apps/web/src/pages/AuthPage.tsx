      ...
      <div className="relative flex flex-1 z-10 items-center justify-center gap-16 px-12 py-10">
        ...
        <div className="flex flex-col justify-between" style={{ width: '380px' }}>
          ...
          <div className="flex items-center gap-3">
            <img src="/logo.png" alt="FormPlan" className="h-20 w-auto" />
          </div>

          {/* Hero text */}
          <div className="mb-16">
            <h1 className="font-extrabold leading-tight mb-4" style={{ fontSize: '44px' }}>
              <span className="text-emerald-400">AI-genererat</span>{' '}
        ...
        <div style={{ width: '580px', flexShrink: 0,
          ...
          boxShadow: '0 0 60px rgba(16,185,129,0.2), 0 0 120px rgba(16,185,129,0.08), 0 25px 50px rgba(0,0,0,0.5)',
          borderRadius: '20px',
          padding: '40px',
          display: 'flex',
          alignItems: 'center',
          ...
          <div style={{ width: '100%', maxWidth: '380px' }}>
            <div>
              ...
              <div className="flex justify-center mb-6">
                <img src="/logo.png" alt="FormPlan" style={{ height: '100px', width: 'auto' }} />
              </div>
                  ...
                  <form onSubmit={handleMagicLink} className="space-y-3">
                    <div className="relative">
                      ...
                      <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                        ...
                        className="w-full pl-11 pr-4 py-4 rounded-xl text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-emerald-500/50 transition-all"
                        style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.12)' }}
                      />
                    </div>
                    {error && <p className="text-red-400 text-xs">{error}</p>}
                    <button type="submit" disabled={loading}
                      className="w-full flex items-center justify-between px-5 py-4 rounded-xl text-sm font-semibold text-white transition-all disabled:opacity-60"
          ...
          {[
            ...
            <div key={f.title} className="flex items-start gap-3 flex-1">
              <div className="w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5"
                ...
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="#10b981">
