      ...
      {tab === 'vecka' ? (
        ...
        <div className="px-5 py-6 space-y-6">
          ...
          <button
            ...
            onClick={handleAdd}
            disabled={adding}
            className="w-full bg-forest-700 hover:bg-forest-800 active:bg-forest-800 disabled:opacity-60 text-white font-semibold py-3.5 rounded-xl flex items-center justify-center gap-2 transition-colors"
          >
